...
def simple_two_step_pipeline_with_ailment_tracking(participant_id, window_size=100, seed=42):
    """
    ...
    # Evaluate Step 1
    test_predictions = ensemble_trainer.predict(test_loader, minority_weight=1.5, threshold=0.8)
...
if __name__ == "__main__":
    ...
    participant_id = 1
    try:
        results = simple_two_step_pipeline_with_ailment_tracking(participant_id, window_size, seed)
        print("\n" + "=" * 60)
